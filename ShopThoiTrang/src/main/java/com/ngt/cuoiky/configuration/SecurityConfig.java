...
public class SecurityConfig {
    ...
    // xac minh dang nhap (https://www.javadevjournal.com/spring/spring-security-userdetailsservice/)
    @Bean
    public DaoAuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider();
        authProvider.setUserDetailsService(userDetailsService()); // return all information of user
        authProvider.setPasswordEncoder(passwordEncoder()); // decrypt password
        return authProvider;
    }
}
